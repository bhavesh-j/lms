                ...
                <div className="wrapper_body">
                  ...
                  <div className="col-12 ml-4">
                    ...
                    <div>
                      <div className="date">
                        <span>Date:</span>
                        <input type="text" defaultValue={this.formatDate()} style={{width: '70%'}} />
                      </div>
                      <br />
                      <br />
                      <p>This is to certify that 
                        <input type="text" style={{textAlign: 'center', width: '18%'}}
                          defaultValue={student.firstName+' '+student.lastName} className="txt_fld" />
                        Daughter/Son of 
                        <input type="text" style={{textAlign: 'center', width: '18%'}}
                          defaultValue={parent.firstName+' '+parent.lastName} className="txt_fld" />
                        attending this School from
                        <input type="text" defaultValue="03/11/2020" className="txt_fld"
                          style={{width: '100px', textAlign: 'center'}} />
                        to
                        <input type="text" defaultValue={this.formatDate()} className="txt_fld" style={{width: '100px', textAlign: 'center'}} />
                        and now leaves the School having paid all dues to date.<br />
                        His/Her date of birth as per School records is (in figures)
                        <input type="text" defaultValue={this.formatDate(student.dateOfBirth)} className="txt_fld" style={{width: '100px', textAlign: 'center'}} />
                        in words
                        ...
                        <input type="text" defaultValue={student.className+' / '+student.sectionName} className="txt_fld" style={{width: '20%', textAlign: 'center'}} /> 
